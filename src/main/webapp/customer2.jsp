...
<script type="text/javascript">
	$(function() {
		$.ajax({
		        type : "post",
			    url : "/MySSH/film/toSelectAllAddressAjax",
				dataType : "json",
				success : function(addressList) {
					for ( var indexs in addressList) {
						var src = "<option value='"+addressList[indexs].address_id+"''>"+ addressList[indexs].address + "</option>"
...
<body onload="ajaxpage(pages)">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 dhn-top">
				<a class="dhn-top-left" href="#">
					<span class="fui-list">${name}</span>
				</a> 
				<a class="dhn-top-right" href="/MySSH/film/toLogin"> 
			...
			<div class="col-md-2 dhn-content-left ">
				<div class="dhn-left-inner">
					<button class=" btn btn-info leftbutton  dhn-active">
						<span class="fui-list-small-thumbnails lefticon"></span>
							customer管理
						<span class="fui-arrow-right righticon"></span>
					</button>
					<form action="/MySSH/film/toAllAddress">
						<button class="btn btn-info leftbutton  dhn-active"
							style="width: 100%;">
							<span class="fui-list-small-thumbnails lefticon"></span>
								film设置
							...
							<div class="panel panel-default">
								<div class="panel-body">
									客户列表 <a class="btn btn-info btn-default"
										href="/MySSH/film/toAllAddress">新增</a>
								</div>
							</div>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<form action="/MySSH/film/toUpdate">
